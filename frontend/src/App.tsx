    ...
    <Routes>
      ...
      <Route path={ROUTES.LANDING} element={
        <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-indigo-900">
          ...
          {/* Image Gallery Section - Professional Training in Action */}
          <div className="px-4 sm:px-6 py-12 sm:py-20">
            <div className="max-w-7xl mx-auto">
              <h3 className="text-2xl sm:text-3xl font-bold text-white text-center mb-4 sm:mb-6 px-2">Experience Professional Training</h3>
              <p className="text-lg text-gray-200 text-center mb-12 sm:mb-16 max-w-3xl mx-auto px-4">
                See how DRP Workshop transforms athletes with data-driven training, expert coaching, and cutting-edge technology.
              </p>
              
              {/* Hero Images - Large Feature */}
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-8">
                <div className="relative overflow-hidden rounded-xl shadow-2xl">
                  <img 
                    src="/action.jpeg" 
                    alt="Professional athlete training with coach guidance"
                    className="w-full h-64 sm:h-80 object-cover hover:scale-105 transition-transform duration-500"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                  <div className="absolute bottom-4 left-4 text-white">
                    <h4 className="text-lg font-semibold mb-1">Personalized Training</h4>
                    <p className="text-sm text-gray-200">Expert coaching tailored to each athlete</p>
                  </div>
                </div>
                ...
                <div className="relative overflow-hidden rounded-xl shadow-2xl">
                  <img 
                    src="/drpanalyze.jpeg" 
                    alt="Coach analyzing athlete performance data with tablet"
                    className="w-full h-64 sm:h-80 object-cover hover:scale-105 transition-transform duration-500"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                  <div className="absolute bottom-4 left-4 text-white">
                    <h4 className="text-lg font-semibold mb-1">Data-Driven Analysis</h4>
                    <p className="text-sm text-gray-200">Real-time performance tracking and insights</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                <div className="relative overflow-hidden rounded-lg shadow-lg">
                  <img 
                    src="/actionfunny.jpeg" 
                    alt="Athletes enjoying training session"
                ...
                <div className="relative overflow-hidden rounded-lg shadow-lg">
                  <img 
                    src="/hypeclose.jpeg" 
                    alt="Young athletes in intensive training"
                    className="w-full h-40 sm:h-48 object-cover hover:scale-105 transition-transform duration-500"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent"></div>
                  <div className="absolute bottom-2 left-2 text-white">
                    <p className="text-xs font-medium">Youth Development</p>
                  </div>
                </div>
                
                <div className="relative overflow-hidden rounded-lg shadow-lg">
                  <img 
                    src="/kidactionshot.jpeg" 
                    alt="Young athletes in action during training"
                    className="w-full h-40 sm:h-48 object-cover hover:scale-105 transition-transform duration-500"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent"></div>
                  <div className="absolute bottom-2 left-2 text-white">
                    <p className="text-xs font-medium">Athletic Excellence</p>
                  </div>
                </div>
              </div>
            </div>
