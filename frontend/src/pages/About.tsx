            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
              ...
              <div className="text-center">
                <div className="relative overflow-hidden rounded-xl shadow-2xl">
                  <img 
                    src="/action.jpeg" 
                    alt="Professional coaching and athlete development"
                    className="w-full h-64 sm:h-80 object-cover hover:scale-105 transition-transform duration-500"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent"></div>
                  <div className="absolute bottom-4 left-4 text-white">
                    <h4 className="text-lg font-semibold mb-1">Professional Excellence</h4>
                    <p className="text-sm text-gray-200">Building champions through expert guidance</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
              <div className="text-center">
                <div className="relative overflow-hidden rounded-xl shadow-2xl">
                  <img 
                    src="/hypeclose.jpeg" 
                    alt="Coaches collaborating, representing our story"
                    className="w-full h-64 sm:h-80 object-cover hover:scale-105 transition-transform duration-500"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent"></div>
                  <div className="absolute bottom-4 left-4 text-white">
                    <h4 className="text-lg font-semibold mb-1">Our Story</h4>
                    <p className="text-sm text-gray-200">Born from a passion for coaching excellence</p>
                  </div>
                </div>
              </div>
              <div>
                ...
                <p className="text-base sm:text-lg text-gray-200 leading-relaxed mb-4 sm:mb-6 px-2">
                  DRP Workshop was born from a simple observation: coaches were spending too much time on administrative tasks and not enough time doing what they love - coaching.
                </p>
                <p className="text-base sm:text-lg text-gray-200 leading-relaxed px-2">
