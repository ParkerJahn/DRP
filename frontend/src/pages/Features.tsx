        ...
        <div className="px-4 sm:px-6 py-8 sm:py-12">
          <div className="max-w-6xl mx-auto">
            <div className="relative overflow-hidden rounded-xl shadow-2xl">
              <img 
                src="/drpj.jpeg" 
                alt="Professional coaching session showcasing DRP Workshop features"
                className="w-full h-64 sm:h-96 object-cover hover:scale-105 transition-transform duration-500"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
              <div className="absolute bottom-6 left-6 text-white">
                <h3 className="text-xl sm:text-2xl font-bold mb-2">Professional Coaching Platform</h3>
                <p className="text-sm sm:text-base text-gray-200">Experience the tools that transform how coaches and athletes work together</p>
              </div>
            </div>
          </div>
        </div>
